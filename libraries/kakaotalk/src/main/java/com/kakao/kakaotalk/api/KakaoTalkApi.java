...
public class KakaoTalkApi {
    ...
    public MessageSendResponse requestBroadcastMessage(@NonNull final List<Long> receiverIds,
                                                       @NonNull final String templateId,
                                                       @Nullable final Map<String, String> args) throws Exception {
        AuthorizedRequest request = new CustomMessageBroadcastRequest(receiverIds, templateId, args);
    ...
    public MessageSendResponse requestBroadcastMessage(@NonNull final List<Long> receiverIds,
        ...
        AuthorizedRequest request = new DefaultMessageBroadcastRequest(receiverIds, templateParams);
        return networkService.request(request, MessageSendResponse.CONVERTER);
    }

    public MessageSendResponse sendMessageToAppFriends(
            @NonNull final List<Long> appFriendIds,
            @NonNull final String url,
            @Nullable final String templateId,
            @Nullable final Map<String, String> templateArgs
    ) throws Exception {
        ScrapMessageBroadcastRequest request = new ScrapMessageBroadcastRequest(appFriendIds, url, templateId, templateArgs);
        return networkService.request(request, MessageSendResponse.CONVERTER);
    }
