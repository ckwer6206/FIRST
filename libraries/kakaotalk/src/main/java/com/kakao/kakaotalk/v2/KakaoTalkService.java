...
public class KakaoTalkService {
     ...
     *
     * @param appFriendIds 친구 API 를 통하여 획득한 친구 앱유저아이디 목록. 현재 최대 길이 5.
    ...
    public Future<MessageSendResponse> sendMessageToFriends(
        ...
        return taskQueue.addTask(new KakaoResultTask<MessageSendResponse>(callback) {
            ...
            public MessageSendResponse call() throws Exception {
                return api.requestBroadcastMessage(appFriendIds, templateId, templateArgs);
            }
        });
    }
    ...
    public Future<MessageSendResponse> sendMessageToFriends(
        ...
        return taskQueue.addTask(new KakaoResultTask<MessageSendResponse>(callback) {
            @Override
            public MessageSendResponse call() throws Exception {
                return api.requestBroadcastMessage(appFriendIds, templateParams);
            }
        });
    }
    ...
    public Future<MessageSendResponse> sendMessageToFriends(
        ...
        return taskQueue.addTask(new KakaoResultTask<MessageSendResponse>(callback) {
            @Override
            public MessageSendResponse call() throws Exception {
                return api.sendMessageToAppFriends(appFriendIds, url, templateId, templateArgs);
            }
        });
    }
