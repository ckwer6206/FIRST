...
public class KakaoNaviWebViewActivity extends Activity {
    ...
    public class KakaoNaviWebViewClient extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            if (KakaoNaviProtocol.NAVI_MARKET_URL.equals(url)) {
    ...
    private void loadKakaoNaviWebView() {
        ...
        WebView webView = findViewById(R.id.navi_web_view);
    ...
    private void showSettingsAlertDialog() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP_MR1) {
            builder = new AlertDialog.Builder(this, android.R.style.Theme_DeviceDefault_Light_Dialog_Alert).setTitle(getResources().getString(R.string.permission_error_title));
        } else {
            builder = new AlertDialog.Builder(this, android.R.style.Theme_DeviceDefault).setTitle(getResources().getString(R.string.permission_error_title));
        }
        alertDialog = builder
