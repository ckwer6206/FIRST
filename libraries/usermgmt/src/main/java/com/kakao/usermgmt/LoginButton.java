...
public class LoginButton extends FrameLayout {
    ...
    private androidx.core.app.Fragment supportFragment;
    ...
    /*
        ...
        위 링크에 Focusable flag 를 사용하여 fullscreen / immersvie mode를 깨지 않도록 임시로 지정해준 후,
...
//        }
    ...
    public void setSuportFragment(final androidx.core.app.Fragment fragment) {
    ...
    public androidx.core.app.Fragment getSupportFragment() {
