...
public class UserManagement {
     ...
     * @deprecated in 1.11.0. Use {@link #me(MeV2ResponseCallback)} instead
     */
    @Deprecated
     ...
     * @deprecated in 1.11.0. Use {@link #me(List, MeV2ResponseCallback)} instead
     */
    @Deprecated
     ...
     *
     * - Now this API does not invoke error callback even if user has not signed up yet. Deprecated
     * {@link #requestMe(MeResponseCallback)} and {@link #requestMe(MeResponseCallback, List, boolean)}
     * invoked {@link ApiResponseCallback#onNotSignedUp()} if user did not sign up yet.
     *
